...
public class Check  extends JFrame {
        ...
        private JTextArea encryptbox = new JTextArea(4,20);
    private JTextArea decryptbox = new JTextArea(4,20);
    private JTextArea openc = new JTextArea(4,20);
    private JTextArea opdec = new JTextArea(4,20);
    private JPanel panel1 = new JPanel();
    private JPanel panel2 = new JPanel();
    private JPanel panel3 = new JPanel();
    private JButton encrypt = new JButton("ENCRYPT");
    private JButton decrypt = new JButton("DECRYPT");
    String[] choose =  {"TDES", "OTP", "AES"};
    ...
    public Check(){
        setTitle("ENCRYPTION AND DECRYPTION ALGORITHMS");
        setVisible(true);
        setResizable( false );
        ...
        encryptbox.setForeground(Color.RED);
        decryptbox.setForeground(Color.RED);
        openc.setForeground(Color.RED);
        opdec.setForeground(Color.RED);
        decryptbox.setFont(new Font("Calibra",Font.BOLD,16));
        encryptbox.setFont(new Font("Calibra",Font.BOLD,16));
        opdec.setFont(new Font("Calibra",Font.BOLD,16));
        openc.setFont(new Font("Calibra",Font.BOLD,16));
        encryptbox.setLineWrap(true);
        decryptbox.setLineWrap(true);
        openc.setLineWrap(true);
        opdec.setLineWrap(true);
        
        panel1.setLayout(new FlowLayout(FlowLayout.CENTER, 6, 12));
        panel2.setLayout(new FlowLayout(FlowLayout.CENTER, 6, 12));
        panel3.setLayout(new FlowLayout(FlowLayout.CENTER, 6, 12));
